...
<div class="max-w-2xl mx-auto">
    ...
    <form action="{{ route('admin.dishes.store') }}" method="POST" class="space-y-6">
            ...
            <div class="p-6 border-b border-gray-200">
                ...
                <div class="mt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-500">Mô tả ngắn gọn về món ăn, nguyên liệu, cách chế biến...</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="price" id="price" min="0" step="1000" value="{{ old('price') }}" required
                    ...
                    <div class="mt-4 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                        <div class="space-y-1 text-center">
                            ...
                            <div class="flex text-sm text-gray-600">
                                <label for="image_upload" class="relative cursor-pointer bg-white rounded-md font-medium text-primary-600 hover:text-primary-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary-500">
        ...
        <div class="flex justify-between">
            <a href="{{ route('admin.dishes.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
