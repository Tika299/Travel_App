...
class HCMDataSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        if (CheckinPlace::count() > 0 && Hotel::count() > 0 && Restaurant::count() > 0) {
            $this->command->info('Data already exists. Skipping...');
            return;
        }
        
        $this->command->info('Adding new data for Ho Chi Minh City...');
        ...
        $this->command->info('Added ' . count($checkinPlaces) . ' checkin places.');
        ...
        $hotels = [
            ...
            [
                'name' => 'Khách sạn Grand Hotel Saigon',
        ...
        $this->command->info('Added ' . count($hotels) . ' hotels.');
        ...
        $restaurants = [
            ...
            [
                'name' => 'Nhà hàng Pho 2000',
                'description' => 'Nhà hàng phở nổi tiếng, từng được Tổng thống Mỹ Bill Clinton ghé thăm',
                'address' => '1-3 Dinh Tien Hoang, Quận 1, TP.HCM',
                'latitude' => 10.7769,
                'longitude' => 106.6992,
                'rating' => 4.1,
            ...
            [
                'name' => 'Nhà hàng Banh Mi Huynh Hoa',
                'description' => 'Tiệm bánh mì nổi tiếng với bánh mì thịt nguội',
                'address' => '26 Le Thi Rieng, Quận 1, TP.HCM',
                'latitude' => 10.7769,
                'longitude' => 106.6992,
                'rating' => 4.4,
        ...
        $this->command->info('Added ' . count($restaurants) . ' restaurants.');
        
        $this->command->info('✅ Successfully added real data for Ho Chi Minh City!');
        $this->command->info('📊 Summary:');
        $this->command->info('- Checkin Places: ' . CheckinPlace::count());
