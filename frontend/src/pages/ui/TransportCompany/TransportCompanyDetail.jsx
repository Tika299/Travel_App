        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-6">
          <div className="col-span-7 text-left">
            ...
            <div className="mt-4">
              ...
              <div className="flex flex-wrap gap-3 text-sm">
                <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full">Ứng dụng di động</span>
                <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full">Thanh toán online</span>
                <span className="bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full">Bảo hiểm</span>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-3 text-right">
            ...
            <ul className="text-sm space-y-2">
              <li><strong>📍 Địa chỉ:</strong> {company.address || 'Đang cập nhật'}</li>
              <li><strong>📞 Hotline:</strong> {company.phone_number || '—'}</li>
              <li><strong>📧 Email:</strong> {company.email || '—'}</li>
              <li>
                <strong>🌐 Website:</strong>{' '}
                {company.website ? (
                  <a href={company.website} target="_blank" rel="noopener noreferrer" className="text-blue-600 underline hover:text-blue-800">
                    {company.website}
                  </a>
                ) : (
                  '—'
