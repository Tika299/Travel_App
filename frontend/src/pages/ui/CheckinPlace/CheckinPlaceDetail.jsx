  ...
  const loadPlaceData = () => {
    getCheckinPlaceById(id)
      .then((res) => {
          ...
          data.reviews = [
            {
              ...
              rating: 5,
              comment:
                "Cảnh tượng thực sự là một kiệt tác kiến trúc! Cảnh quan từ trên xuống rất hùng vĩ và ấn tượng. Đồi bàn tay khổng lồ tạo nên điểm nhấn độc đáo. Tuy nhiên, vào cuối tuần khá đông khách nên cần có thời gian chờ đợi để chụp ảnh.",
              likes: 23,
              avatar: "https://via.placeholder.com/40/FF5733/FFFFFF?text=NA",
            },
            {
              id: 2,
              ...
              rating: 4,
              comment:
                "Địa điểm tuyệt vời để check-in và chụp ảnh! Cáp treo lên Ba Na Hills cũng rất thú vị. Giá vé hơi cao nhưng xứng đáng với trải nghiệm. Nên đi vào buổi sáng sớm để tránh đông người và thời tiết mát mẻ hơn.",
              likes: 39,
              avatar: "https://via.placeholder.com/40/3366FF/FFFFFF?text=KA",
            },
            {
              id: 3,
              ...
              rating: 5,
              comment:
                "Tuyệt vời ông mặt trời! Cảnh đẹp mê hồn, nhất định phải quay lại lần nữa.",
              likes: 15,
            ...
            },
            {
              ...
              rating: 3,
              comment:
                "Khá đông, nhưng bù lại cảnh đẹp và có nhiều chỗ ăn uống.",
              likes: 8,
        ...
        console.log("--- Ảnh chính được đặt (mainImage):", initialMainImage); // LOG 7
      })
        ...
        <div className="md:w-1/2 space-y-4">
            ...
            <div className="flex justify-around items-center">
              ...
              <div className="text-center">
                <p className="text-xl font-bold text-purple-600">
                  {place.review_count?.toLocaleString() || 0}
                </p>
          ...
          <div className="space-y-1 text-sm text-gray-800">
            ...
            <div className="flex justify-between items-center">
              ...
              {/* Dữ liệu cứng, có thể làm động sau */}
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-8">
          ...
          <div className="flex flex-col items-center justify-center p-4 bg-gray-50 rounded-lg w-full md:w-1/4 flex-shrink-0 border border-gray-200">
            ...
            <p className="text-sm text-gray-600 mt-1">
              Dựa trên {place.review_count?.toLocaleString() || 0} đánh giá
            </p>
          </div>
              ...
              <div key={star} className="flex items-center gap-2">
                ...
                <div className="flex-grow bg-gray-200 h-2 rounded-full">
                  <div
                    ...
                    style={{
                      width: `${(
                        (place.rating_breakdown?.[star] || 0) * 100
                      ).toFixed(0)}%`,
                    }}
                  ></div>
                </div>
          ...
          <div className="text-center mt-6">
            ...
            >
              {showAllReviews
                ? "Thu gọn"
                : `Xem thêm (${
                    place.reviews.length - reviewsToDisplay.length
                  } đánh giá)`}
            </button>
          </div>
        )}
