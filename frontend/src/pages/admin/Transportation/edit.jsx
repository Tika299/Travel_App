...
const EditTransportation = () => {
    ...
    useEffect(() => {
        const fetchTransportationData = async () => {
            try {
                ...
                alert('Không tìm thấy loại phương tiện này hoặc có lỗi khi tải dữ liệu!');
    ...
    const handleFile = useCallback((field, file) => {
        ...
        setPreview(prev => ({ ...prev, [field]: file ? URL.createObjectURL(file) : null }));
    }, []);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Object.entries(form).forEach(([k, v]) => {
                ...
                } else if (v !== null) { // Bỏ qua icon và banner nếu không có file mới
                    fd.append(k, v);
                }
            });
            ...
            if (!form.banner && preview.banner && typeof preview.banner === 'string') {
                // Tương tự cho banner
    ...
    const handleReset = () => {
        if (initialFormState) {
            ...
            setPreview({ icon: initialFormState.icon_url, banner: initialFormState.banner_url });
        }
    };
        ...
        <div className="min-h-screen bg-gray-100 font-inter p-6">
            <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <header className="flex items-center justify-between p-6 bg-white border-b border-gray-200">
                    <h1 className="text-2xl font-bold text-gray-800">Chỉnh sửa phương tiện</h1>
                ...
                <div className="p-6 bg-gray-50 border-b border-gray-200">
                    ...
                    <p className="text-sm text-gray-500 ml-10">Điền các thông tin cần thiết về danh sách phương tiện</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {/* Tên Phương tiện */}
                            <div>
                                <label htmlFor="name" className="block text-sm font-medium text-gray-700">Tên phương tiện *</label>
                                <input
                                    type="text"
                                    id="name"
                                    name="name"
                            ...
                            {/* Icon Phương tiện */}
                            <div>
                                <label htmlFor="icon" className="block text-sm font-medium text-gray-700">Icon phương tiện (tuỳ chọn)</label>
                                <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md cursor-pointer hover:border-blue-500 transition-colors duration-200">
                                    <div className="space-y-1 text-center">
                                        ...
                                        <div className="flex text-sm text-gray-600">
                                            <label htmlFor="icon_file" className="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                    ...
                    <div className="space-y-4 pt-4">
                        ...
                        <div>
                            <label htmlFor="banner" className="block text-sm font-medium text-gray-700">Ảnh chính (Banner) (tuỳ chọn)</label>
                            <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md cursor-pointer hover:border-blue-500 transition-colors duration-200">
                                <div className="space-y-1 text-center">
                                    ...
                                    <div className="flex text-sm text-gray-600">
                                        <label htmlFor="banner_file" className="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                        <fieldset className="p-4 border border-gray-200 rounded-md shadow-sm">
                            ...
                            <div className="space-y-2">
                                {tags.map((t) => (
                                    <label key={t} className="flex items-center space-x-2 text-gray-700">
                                        <input
                                            type="checkbox"
                        ...
                        <fieldset className="p-4 border border-gray-200 rounded-md shadow-sm">
                            ...
                            <div className="space-y-2">
                                {features.map((f) => (
                                    <label key={f} className="flex items-center space-x-2 text-gray-700">
                                        <input
                                            type="checkbox"
                                            ...
                                            className="form-checkbox h-4 w-4 text-blue-600 rounded"
                                        />
                                        <span>{f.replace(/_/g, ' ')}</span> {/* Hiển thị tên tính năng dễ đọc hơn */}
                                    </label>
                                ))}
                            </div>
                        </fieldset>
                    ...
                    <div className="pt-4">
                        <label className="flex items-center space-x-2 text-gray-700">
                            ...
                            />
                            <span className="text-base font-medium">Hiển thị trên trang người dùng</span>
                        </label>
                    </div>
