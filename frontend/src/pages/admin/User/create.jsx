    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm border-b px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-semibold text-gray-800">Thêm người dùng mới</h1>
            <p className="text-sm text-gray-500 mt-1">Tạo tài khoản mới cho người dùng trong hệ thống</p>
          </div>
            ...
            <div className="border-b bg-blue-50 p-6">
              <div className="flex items-center text-blue-700">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">Điền đầy đủ thông tin để tạo tài khoản tài khoản</p>
                </div>
              </div>
            </div>
            <div className="p-6">
